...
/**
 * Zobrazí horný navigačný panel s nadpisom, voliteľným tlačidlom späť a avatarom používateľa.
 *
 * @param {Object} props - Vstupné parametre komponentu.
 * @param {string} props.text - Text (názov obrazovky) zobrazovaný v hlavičke.
 * @param {boolean} props.back - Ak true, zobrazí sa tlačidlo späť.
 * @param {boolean} [props.courses_list] - Ak je true a `back` je false, umožní kliknúť na avatar pre prechod do profilu.
 * @returns {JSX.Element} React komponent hlavičky.
 */
